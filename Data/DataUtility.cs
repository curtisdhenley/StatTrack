...
namespace StatTracker.Data
{
    public class DataUtility
    {
        ...
        public static async Task ManageDataAsync(IServiceProvider serviceProvider)
        {
            ...
            var userManagerSvc = serviceProvider.GetRequiredService<UserManager<BTUser>>();
            // Service: An instance of Rolemanger
        ...
        public static async Task SeedDefaultTicketTypesAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketType> ticketTypes = new List<TicketType>() {
                     new TicketType() { Name = nameof(BTTicketTypes.NewDevelopment) },      // Tickets involves development of a new, uncoded solution 
                     new TicketType() { Name = nameof(BTTicketTypes.WorkTask) },            // Tickets involves development of the specific ticket description 
                     new TicketType() { Name = nameof(BTTicketTypes.Defect)},               // Tickets involves unexpected development/maintenance on a previously designed feature/functionality
                     new TicketType() { Name = nameof(BTTicketTypes.ChangeRequest) },       // Tickets involves modification development of a previously designed feature/functionality
                     new TicketType() { Name = nameof(BTTicketTypes.Enhancement) },         // Tickets involves additional development on a previously designed feature or new functionality
                     new TicketType() { Name = nameof(BTTicketTypes.GeneralTask) }          // Tickets involves no software development but may involve tasks such as configuations, or hardware setup
                };
        ...
        public static async Task SeedDefaultTicketStatusesAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketStatus> ticketStatuses = new List<TicketStatus>() {
                    ...
                    new TicketStatus() { Name = nameof(BTTicketStatuses.Development) },         // Tickets is assigned and currently being worked 
                    new TicketStatus() { Name = nameof(BTTicketStatuses.Testing)  },            // Tickets is assigned and is currently being tested
                    new TicketStatus() { Name = nameof(BTTicketStatuses.Resolved)  },           // Tickets remains assigned to the developer but work in now complete
                };
