...
namespace StatTracker.Data
{
	public class DataUtility
	{
		...
		public static async Task ManageDataAsync(IServiceProvider svcProvider)
		{
			...
			var userManagerSvc = svcProvider.GetRequiredService<UserManager<BTUser>>();            // Service: An instance of RoleManager
			var roleManagerSvc = svcProvider.GetRequiredService<RoleManager<IdentityRole>>();            // Migration: This is the programmatic equivalent to Update-Database
